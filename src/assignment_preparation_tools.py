...
def build_assignment_context_data(
    subject_id: int,
    assessment_id: int,
    professor_id: int | None = None,
) -> dict:
    """
    Reúne el contexto estructurado de una entrega.

    Esta función puede reutilizarse desde otras tools.
    """
...
def register_assignment_preparation_tools(mcp) -> None:
    """Registra herramientas de preparación de trabajos."""
    ...
    def build_assignment_preparation_context(
        ...
        result = build_assignment_context_data(
